      ...
      <div className="pop-left">
        <div class="card">
          ...
          <p class="info">
            ...
            Register today and become a trusted partner in delivering affordable
            healthcare solutions. We empower pharmacies with technology for
            smarter business and better patient care.
          </p>
          <div class="share">
            <a href="">
              <svg
          ...
          <form className="login-popup-container" onSubmit={handleSubmit}>
            ...
            <div className="login-popup-inputs">
              ...
              {currState === "Sign Up" && (
                <input
                  type="text"
                  placeholder="Enter your Medical History (e.g., allergies, conditions)"
